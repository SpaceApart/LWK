...
export interface Tag {
  ...
  icon?: string | null;
  /**
   * Select the type of content this tag relates to.
   */
  tagScope: 'offers' | 'attractions' | 'experiences' | 'photos' | 'posts';
  slug: string;
  updatedAt: string;
  createdAt: string;
  _status?: ('draft' | 'published') | null;
...
export interface Attraction {
  ...
  /**
   * Enter an address to attempt automatic geocoding. Coordinates will populate the Location (Map Coordinates) field.
   */
  address_text?: string | null;
  /**
   * Współrzędne [długość, szerokość geograficzna]. Kliknij na mapie lub wprowadź ręcznie.
   *
   * @minItems 2
   * @maxItems 2
   */
  location_map?: [number, number] | null;
  images?:
    | {
        image: number | Media;
        id?: string | null;
